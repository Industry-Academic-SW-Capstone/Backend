...
//
// 개방형(ramping-arrival-rate)을 쓴다. 폐쇄형(stages + VU)은 시스템이 느려지면 요청 속도가
// 같이 떨어져, 유입이 처리 능력을 넘는 상황 자체를 만들 수 없다.
//
// 판정: 체결 지연이 꺾여 오르기 시작하는 지점 = 포화점
...
//   --env STAGE_BASE=100   앞 회차에서 상한이 100 근처로 나왔을 때
//   --env STAGE_BASE=15    훨씬 느린 구성을 잴 때
