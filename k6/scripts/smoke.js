...
//
// 판정: execution_count > 0. 0이면 시딩이 안 됐거나 가격 조건이 안 맞은 것이다.

import { login, defaultAccountId, seedOrderBook, injectExecution } from './lib/common.js';
...
export const options = {
  ...
  thresholds: {
    ...
    // 수신 경로가 막히면 이 값이 오른다.
    handle_ms: ['p(95)<5000'],
    // 체결이 한 건도 없으면 측정 자체가 성립하지 않는다(시딩·가격 조건 문제).
