...
public class SecurityConfig {
     ...
     *
     * {@code /ws/**}: SockJS 핸드셰이크는 Authorization 헤더를 실을 수 없다. 현재 STOMP로
     ...
     *
     * {@code /actuator/**}: Prometheus가 토큰 없이 스크레이프하므로 열어둔다
     ...
     *
     * 여기 걸리지 않는 형식의 종목코드가 생기면 비로그인 상세 조회가 401이 된다.
